...
final class MarkdownContentViewTests: XCTestCase {
    ...
    func testRenderHTMLBodyUsesGitHubFlavoredTables() {
        ...
        XCTAssertTrue(html.contains("class=\"wiki-link\" href=\"mywiki://page?target=Planner\""))
    ...
    func testRenderHTMLBodyDecoratesInternalLinksOnly() {
        ...
        XCTAssertTrue(html.contains("<a class=\"wiki-link\" href=\"mywiki://page?target=Planner\">Planner</a>"))
        XCTAssertTrue(html.contains("<a class=\"file-link\" href=\"mywiki-asset:///workspace/Cutting%20Cards%20-%20AI.pdf\">Cutting Cards - AI.pdf</a>"))
