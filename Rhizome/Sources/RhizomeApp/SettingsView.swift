...
struct SettingsView: View {
    ...
    private var claudeCommandsSection: some View {
        VStack(alignment: .leading, spacing: 14) {
            ...
            VStack(alignment: .leading, spacing: 10) {
                Text("Slash commands live in `.claude/commands/` inside your wiki. Edit them in any editor to customize how Claude responds. After updating Rhizome, use Reset to Defaults to pick up new shipped commands (this overwrites your edits).")
                    .font(.system(size: 13, design: activeFont.design))
                    .foregroundStyle(EditorialPalette.textSecondary)
                    .fixedSize(horizontal: false, vertical: true)
